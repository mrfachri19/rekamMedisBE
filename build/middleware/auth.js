...
const helperWrapper = require("../helper/wrapper"); // const redis = require("../config/redis");
...
module.exports = {
  authentication: (req, res, next) => {
    ...
    token = token.split(" ")[1]; // redis.get(`accessToken:${token}`, (error, result) => {
